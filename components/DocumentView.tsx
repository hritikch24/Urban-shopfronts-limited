  ...
  return (
    <div className="min-h-screen bg-grey-100 py-8 px-4 print:bg-white print:py-0 print:px-0">
      <div className="max-w-[210mm] mx-auto">
        ...
        <div className="bg-white shadow-lg print:shadow-none p-10 sm:p-14 font-serif text-black" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
          {/* Letterhead */}
          ...
          {isInvoice && (
            <div className="mb-8 text-[15px]">
              ...
              <ul className="list-disc pl-8 space-y-1.5">
                <li><span className="font-bold">Account Name:</span> {BANK.accountName}</li>
                <li><span className="font-bold">Bank:</span> {BANK.bank}</li>
                <li><span className="font-bold">Account Number:</span> {BANK.accountNumber}</li>
                <li><span className="font-bold">Sort Code:</span> {BANK.sortCode}</li>
              </ul>
              <p className="font-bold underline mt-5">When making payments, please use invoice number as references.</p>
            </div>
          )}
          ...
          <div className="mt-16 text-[13px] leading-relaxed">
            ...
            <p><span className="font-bold">UTR number:</span> {UTR_NUMBER}</p>
            <p><span className="font-bold">Company&apos;s registration number</span>: {REG_NUMBER}</p>
            <p><span className="font-bold">VAT number:</span> {VAT_NUMBER}</p>

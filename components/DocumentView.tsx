...
export default function DocumentView({ doc }: { doc: DocumentData }) {
  ...
  return (
    <div className="min-h-screen py-10 px-4 print:bg-white print:py-0 print:px-0" style={{ background: 'linear-gradient(135deg, #080818 0%, #0c0c1e 50%, #0a0a16 100%)', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
        ...
        <div style={{ background: C.paper, fontFamily: '"Plus Jakarta Sans", "Segoe UI", Arial, sans-serif', fontSize: '14px', lineHeight: 1.6, color: C.text, boxShadow: '0 25px 60px rgba(0,0,0,0.5)', borderRadius: 4, overflow: 'hidden' }} className="print:shadow-none print:rounded-none">
              ...
              <div>
                ...
                <table style={{ fontSize: 13 }}>
                  <tbody>
                    ...
                    <tr>
                      <td style={{ paddingRight: 16, paddingTop: 3, paddingBottom: 3, fontWeight: 600, color: C.brand }}>VAT No.</td>
                      <td style={{ paddingTop: 3, paddingBottom: 3, color: C.text }}>{VAT_NUMBER}</td>
                    </tr>
                    <tr>
                      <td style={{ paddingRight: 16, paddingTop: 3, paddingBottom: 3, fontWeight: 600, color: C.brand }}>Company Reg.</td>
                      <td style={{ paddingTop: 3, paddingBottom: 3, color: C.text }}>{REG_NUMBER}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div style={{ background: C.brand, padding: '14px 40px', textAlign: 'center' }}>
            <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.85)', margin: 0 }}>
              {COMPANY_NAME} &nbsp;&middot;&nbsp; {COMPANY_ADDRESS} &nbsp;&middot;&nbsp; Reg. {REG_NUMBER}
            </p>

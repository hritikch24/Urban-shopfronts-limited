...
const COMPANY_NAME = 'URBAN SHOPFRONTS LTD';
const COMPANY_ADDRESS = '31 Norton Close, Smethwick, England, B66 3JA';
...
const BANK = {
  accountName: 'URBAN SHOPFRONTS LIMITED',
  bank: 'Revolut Ltd',
      ...
      <div className="max-w-[210mm] mx-auto">
        ...
        <div className="bg-white shadow-lg print:shadow-none text-[#1f2430] text-[14.5px] leading-relaxed overflow-hidden" style={{ fontFamily: 'var(--font-heading), "Segoe UI", Arial, sans-serif' }}>
          ...
          <div className="px-10 pt-6 pb-10">
            ...
            {/* VAT reg + title row */}
            <p className="text-[13px] font-bold mb-4" style={{ color: NAVY }}>VAT Registration Number: {VAT_NUMBER}</p>
            ...
            {/* Bank details band */}
            <div className="border-2 mb-8" style={{ borderColor: NAVY }}>
              <p className="text-center font-bold text-[13px] tracking-widest py-1.5 border-b" style={{ color: NAVY, borderColor: NAVY }}>BANK DETAILS</p>
              <div className="flex flex-wrap justify-center gap-x-10 gap-y-1 px-4 py-3 text-[13.5px]">
                <p><span className="font-bold" style={{ color: NAVY }}>Account Name:</span> {BANK.accountName}</p>
                <p><span className="font-bold" style={{ color: NAVY }}>Bank:</span> {BANK.bank}</p>
                <p><span className="font-bold" style={{ color: NAVY }}>Sort Code:</span> {BANK.sortCode}</p>
                <p><span className="font-bold" style={{ color: NAVY }}>Account No.:</span> {BANK.accountNumber}</p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden text-center text-white px-10 py-4" style={{ backgroundColor: NAVY }}>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/85 text-[12.5px] mt-0.5">{COMPANY_ADDRESS} &nbsp;·&nbsp; Company Reg. {REG_NUMBER}</p>

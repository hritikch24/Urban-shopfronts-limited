      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-grey-300 text-xs mb-4">
              Company Reg: England & Wales
            </p>
            <a
              href="https://www.instagram.com/urbanshopfrontsuk/"
              target="_blank"
              rel="noopener noreferrer me"
              aria-label="Urban Shopfronts on Instagram"
              className="inline-flex items-center gap-2 text-grey-400 hover:text-gold text-sm transition-colors"
            >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  <EmailIcon />
                  <span>sales@urbanshopfronts.co.uk</span>
                </a>
              </li>

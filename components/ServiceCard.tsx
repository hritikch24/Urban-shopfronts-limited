...
export default function ServiceCard({ title, description, image, href }: ServiceCardProps) {
  return (
    ...
    >
      ...
      <div className="p-5 bg-obsidian-light/50 backdrop-blur-sm">
        <h3 className="font-heading font-bold text-white text-lg mb-2 group-hover:text-gold transition-colors duration-300">
          {title}
        </h3>
        <p className="text-grey-500 text-sm leading-relaxed line-clamp-2 mb-4">
          {description}
        </p>
        <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-gold group-hover:gap-3 transition-all duration-300">
          Learn more

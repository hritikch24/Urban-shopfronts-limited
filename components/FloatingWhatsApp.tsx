...
export default function FloatingWhatsApp() {
  ...
  const msg = encodeURIComponent('Hi, I found you online and would like to get a quote for a shopfront installation. Can you help?');

  return (
    <div
      className={`hidden md:flex fixed bottom-6 left-6 z-[50] transition-all duration-300 ${

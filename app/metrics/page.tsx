  ...
  const fetchMetrics = useCallback(async (key: string, p: string) => {
    ...
    try {
      ...
      if (res.status === 401) {
        ...
        sessionStorage.removeItem('_urban_metrics_key');
        return;
      }
      ...
      sessionStorage.setItem('_urban_metrics_key', key);
    } catch {
    ...
    return (
      <div className="min-h-screen bg-navy flex items-center justify-center px-4">
        ...
        <form onSubmit={handleLogin} className="relative bg-grey-100/60 backdrop-blur-2xl rounded-2xl p-10 w-full max-w-sm border border-grey-200/20 shadow-2xl">
          ...
          <h1 className="font-heading font-bold text-2xl text-white text-center mb-1">Urban Metrics</h1>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-heading font-bold text-gold text-lg hidden sm:block">Urban Metrics</span>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => { sessionStorage.removeItem('_urban_metrics_key'); setAuthenticated(false); setData(null); setApiKey(''); }}

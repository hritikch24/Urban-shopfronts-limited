...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes. Urban Shopfronts and Shutter Ltd is registered at Companies House under company number . We carry comprehensive public liability insurance and employers\' liability insurance. Copies of our certificates are available on request. All our installation operatives hold relevant trade cards and have completed appropriate health and safety training.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. All our standard shopfront installations use thermally broken aluminium profiles that comply with Building Regulations Part L (Conservation of Fuel and Power). The polyamide thermal break within the aluminium section prevents heat transfer through the frame, and our double-glazed units typically achieve centre-pane U-values between 1.0 and 1.4 W/m²K. For premises seeking enhanced energy performance, we can specify triple glazing, low-emissivity coatings, and argon-filled cavities.',
  },
  {
...
export default function FAQPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.urbanshopfronts.co.uk"},{"@type":"ListItem","position":2,"name":"FAQ","item":"https://www.urbanshopfronts.co.uk/faq"}]}) }} />
      ...
      <section className="section-padding bg-gradient-dark">
        <div className="container-max text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="tel:+447471043827" className="btn-outline">
              Call 07471 043827
            </a>
          </div>
        </div>

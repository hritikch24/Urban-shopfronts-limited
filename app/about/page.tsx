...
export default function AboutPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.urbanshopfronts.co.uk"},{"@type":"ListItem","position":2,"name":"About Us","item":"https://www.urbanshopfronts.co.uk/about"}]}) }} />
      ...
      <section className="bg-gradient-dark section-padding">
        <div className="container-max">
          ...
          <h1 className="mt-6 text-4xl md:text-5xl font-heading font-bold text-white leading-tight">
            About <span className="text-gradient-gold">Urban Shopfronts</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-grey-600 leading-relaxed">
                <p>
                  Urban Shopfronts was established in the West Midlands by a team of experienced shopfront
                ...
                <p>
                  ...
                  <strong className="text-white"></strong>, and we operate with full public liability
                ...
                <p>
                  Today, Urban Shopfronts offers a complete turnkey service: from initial site survey and
      ...
      <section className="section-padding bg-grey-50">
        <div className="container-max">
          <h2 className="text-3xl font-heading font-bold text-white mb-6">
            Why Businesses Choose Urban Shopfronts
          </h2>
          <div className="grid md:grid-cols-2 gap-8 text-grey-600 leading-relaxed">
            <div className="space-y-4">
              <p>
                In a market crowded with contractors who over-promise and under-deliver, Urban Shopfronts has

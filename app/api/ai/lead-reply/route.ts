...
6. Signs off as Urban Shopfronts team
  ...
  "body": "The full email body text. Use proper paragraphs. British English. Address them by first name."
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a professional sales assistant at Urban Shopfronts, a UK-wide commercial shopfront installation company. Write warm, professional emails in British English. Respond ONLY with valid JSON.",
        },

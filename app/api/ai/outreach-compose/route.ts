...
- Sign off as Urban Shopfronts team
  ...
  "body": "Full email body with proper paragraphs"
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a professional sales assistant at Urban Shopfronts, a UK-wide commercial shopfront installation and repair company. Your goal is to win the job by being helpful, knowledgeable, and building trust. You write persuasive but professional emails. Respond ONLY with valid JSON.',
        },

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://urbanshopfronts.co.uk',
  },
};
...
const testimonials = [
  {
    ...
    location: 'Leeds',
    rating: 5,
    text: 'Urban replaced our old roller shutter in under a day. The team was professional from first contact to final sign-off. Genuinely one of the best trade experiences we have had as a business.',
  },
  {
    name: 'Priya Sharma',
    ...
    location: 'Birmingham',
    rating: 5,
    text: 'We needed a new automatic entrance door for accessibility compliance. Urban surveyed within 48 hours, provided a competitive quote and had it installed within the week. Exceptional service.',
  },
  {
    name: 'Daniel O\'Brien',
    ...
    location: 'Manchester',
    rating: 5,
    text: 'Called Urban at 2am after our shutter was forced open during a break-in. They had a team on site within the hour, secured the premises and followed up with a full replacement the next morning.',
  },
  {
    name: 'Sarah Hennessy',
    ...
    location: 'Bristol',
    rating: 5,
    text: 'Our new bi-fold shopfront has completely transformed the front of the restaurant. Footfall is up and the fit and finish are outstanding. Would highly recommend Urban to any business owner.',
  },
];
  ...
  return (
    <>
      ...
      <section className="section-padding bg-white" aria-labelledby="why-heading">
        <div className="container-max">
          <div className="text-center mb-12 lg:mb-16">
            <p className="text-gold font-semibold text-sm tracking-widest uppercase mb-3">Why Urban</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-grey-600 text-lg leading-relaxed mb-8">
                Urban Shopfronts Limited is a fully registered UK limited company. Our registration with Companies House gives you the peace of mind that you are working with a legitimate, accountable business.
              </p>
              ...
              <div className="card-surface p-6 rounded-2xl mb-6">
                <dl className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <dd className="text-navy font-semibold text-sm">Urban Shopfronts Limited</dd>
                  </div>
                  <div className="flex items-start gap-3">
                    <dt className="text-grey-500 text-sm w-36 flex-shrink-0">Company Number</dt>
                    <dd className="text-navy font-semibold text-sm font-mono"></dd>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="flex items-center gap-3 p-4 bg-gold/10 border border-gold/30 rounded-xl">
                ...
                <p className="text-navy text-sm font-medium">
                  Verifiable at{' '}
                  <a
                    href="https://find-and-update.company-information.service.gov.uk/company/"
                    target="_blank"
            ...
            <div className="order-1 lg:order-2 relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-navy text-white rounded-2xl shadow-xl px-5 py-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gold-light text-xs">No. </p>
                </div>
              </div>
            </div>
          </div>

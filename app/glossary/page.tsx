...
const glossaryTerms: GlossaryTerm[] = [
  {
    ...
    relatedService: { label: 'Aluminium Shopfronts', href: '/services/aluminium-shopfronts' },
  },
  {
    term: 'Anodising',
    definition:
...
export default function GlossaryPage() {
  const schemaData = {
    ...
    '@type': 'DefinedTermSet',
    '@id': 'https://www.urbanshopfronts.co.uk/glossary#termset',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'BreadcrumbList',
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.urbanshopfronts.co.uk' },
              { '@type': 'ListItem', position: 2, name: 'Glossary', item: 'https://www.urbanshopfronts.co.uk/glossary' },
            ],
          }),
        }}
      />

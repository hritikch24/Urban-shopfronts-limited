...
export const metadata: Metadata = {
  title: 'Shopfront Cost Guide 2026 — UK Prices',
  description:
    'What a shopfront actually costs in 2026. Aluminium fronts from £2,000, roller shutters from £800, with the factors that move the price.',
  alternates: { canonical: 'https://www.urbanshopfronts.co.uk/cost-guide' },
  openGraph: {
    title: 'How Much Does a Shopfront Cost in 2026? UK Price Guide | Urban Shopfronts',
      ...
      <section className="section-padding bg-gradient-dark">
        <div className="container-max text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="tel:+447471043827" className="btn-outline">Call 07471 043827</a>
          </div>
        </div>
      </section>

...
export default function DocumentsAdminPage() {
  ...
  function sendWhatsApp(doc: Doc) {
    ...
    const msg = `Hi ${doc.customerName.split(' ')[0]}, here's your ${label} ${doc.number} from Urban Shopfronts:\n${linkFor(doc)}`;
        ...
        <div className="bg-white rounded-2xl border border-slate-200/60 overflow-hidden">
          {loading ? (
            ...
            <div className="py-20 text-center">
              <p className="text-slate-400 text-sm">No {tab === 'quote' ? 'quotes' : 'invoices'} yet</p>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50/80 border-b border-slate-100">
                    ...
                    <th className="py-3 px-4 text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Total</th>
                  ...
                  {documents.map((doc) => {
                    ...
                    return (
                      <tr key={doc.id} className="border-b border-slate-100/60 hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="py-3 px-4 text-sm text-slate-700">£{doc.total.toLocaleString()}</td>
                        <td className="py-3 px-4">

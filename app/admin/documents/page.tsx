...
interface LineItem {
   ...
   * Priced on its own, never added to the total.
   */
  isOption?: boolean;
}
...
export default function DocumentsAdminPage() {
  ...
  function sendWhatsApp(doc: Doc) {
    ...
    if (doc.type === 'auto-quote') {
      ...
      msg = `Hi ${first}, thanks for using our instant estimate for ${what} (ref ${doc.number}). Your guide price was £${lo} – £${hi}. I'd like to arrange a free site survey so we can confirm an exact fixed price — when suits you? — Urban Shopfronts`;
    } else {
      const label = doc.type === 'invoice' ? 'invoice' : 'quote';
      msg = `Hi ${first}, here's your ${label} ${doc.number} from Urban Shopfronts:\n${linkFor(doc)}`;
    }

      ...
      <div className="container-max">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-grey-700 leading-relaxed">
            ...
            <section>
              <p>
                These Terms and Conditions (&ldquo;Terms&rdquo;) govern all quotations, orders, and contracts entered into by <strong className="text-white">Urban Shopfronts Limited</strong> (Company Reg: England & Wales), registered in England and Wales (<strong className="text-white">&ldquo;the Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;</strong>) with our customers (&ldquo;you&rdquo;). Please read them carefully before engaging our services.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <dl className="mt-4 space-y-3">
                <div className="grid grid-cols-[auto_1fr] gap-x-4">
                  <dt className="font-semibold text-white min-w-[130px]">&ldquo;Contract&rdquo;</dt>
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-4">
                  <dt className="font-semibold text-white min-w-[130px]">&ldquo;Goods&rdquo;</dt>
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-4">
                  <dt className="font-semibold text-white min-w-[130px]">&ldquo;Business Customer&rdquo;</dt>
            ...
            <section>
              ...
              <p>
                3.1 All Quotations are valid for <strong className="text-white">30 days</strong> from the date of issue unless otherwise stated in writing. After this period, we reserve the right to revise pricing to reflect changes in material costs or labour rates.
              </p>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">4. Orders and Acceptance</h2>
              <p>
            ...
            <section>
              ...
              <p>
                5.1 <strong className="text-white">Deposit:</strong> A deposit of <strong className="text-white">50%</strong> of the Contract value (or such other amount as specified in the Quotation) is payable upon acceptance of the order and before any Goods are ordered or fabricated.
              </p>
              <p className="mt-4">
                5.2 <strong className="text-white">Balance:</strong> The remaining balance is due upon practical completion of the installation. &ldquo;Practical completion&rdquo; means the point at which the installation is substantially complete and fit for its intended purpose, even if minor snagging items remain outstanding.
              </p>
              <p className="mt-4">
              ...
              <p className="mt-4">
                5.5 All Goods supplied remain the property of Urban Shopfronts Limited until payment in full has been received.
              </p>
            </section>

            {/* 6. Installation */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">6. Installation</h2>
              <p>
                6.1 <strong className="text-white">Site Access:</strong> You must ensure that we have safe, unobstructed access to the Site at all agreed times. This includes ensuring the area is clear of stock, furniture, and other obstructions before our team arrives. If access is delayed or denied, we reserve the right to charge for wasted time at our standard day rate.
              </p>
              <p className="mt-4">
                6.2 <strong className="text-white">Timelines:</strong> We will use reasonable endeavours to meet any installation dates agreed with you. Timelines are estimates and are not guaranteed. We accept no liability for delays caused by factors outside our reasonable control (see Section 11 — Force Majeure).
              </p>
              <p className="mt-4">
                6.3 <strong className="text-white">Structural Suitability:</strong> You warrant that the existing structure (walls, lintels, frames) at the Site is sound and capable of supporting the new installation. We accept no liability for damage caused by pre-existing structural defects that were not apparent at the time of survey.
              </p>
              <p className="mt-4">
                6.4 <strong className="text-white">Utilities:</strong> You are responsible for identifying the location of all underground or concealed services (gas, water, electricity, telecommunications) at the Site. We accept no liability for damage to services not identified prior to works commencing.
              </p>
              <p className="mt-4">
                6.5 <strong className="text-white">Waste Removal:</strong> We will remove all waste arising directly from our installation works from the Site on completion, unless otherwise agreed in writing.
              </p>
              <p className="mt-4">
                6.6 <strong className="text-white">Completion:</strong> On completion, you will be asked to sign a completion certificate confirming that you are satisfied with the works. Signing this certificate does not affect your rights in relation to latent defects or warranty claims.
              </p>
            </section>

            {/* 7. Warranties */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">7. Warranties</h2>
              <p>
                7.1 <strong className="text-white">Workmanship Warranty:</strong> We warrant that all installation work will be free from defects in workmanship for a period of <strong className="text-white">12 months</strong> from the date of practical completion. If any defect in workmanship arises during this period, we will return to rectify it at no charge, subject to the conditions below.
              </p>
              <p className="mt-4">
                7.2 <strong className="text-white">Manufacturer Warranties:</strong> Goods are supplied with the benefit of the relevant manufacturer&rsquo;s warranty, details of which will be provided upon completion. These warranties are separate from, and in addition to, our workmanship warranty and are subject to the relevant manufacturer&rsquo;s terms and conditions.
              </p>
              <p className="mt-4">
                7.3 <strong className="text-white">Warranty Exclusions:</strong> Our workmanship warranty does not cover:
              </p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            {/* 9. Cancellation */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">9. Cancellation</h2>
              <p>
                9.1 <strong className="text-white">Consumers — Cooling-Off Period:</strong> If you are a Consumer and entered into this Contract off-premises or at a distance (e.g. by telephone or online), you have the right to cancel within <strong className="text-white">14 calendar days</strong> of the date the Contract was formed, without giving a reason, under the Consumer Contracts (Information, Cancellation and Additional Charges) Regulations 2013.
              </p>
              <p className="mt-4">
                9.2 <strong className="text-white">Bespoke Goods Exception:</strong> The 14-day cooling-off right does not apply to Goods that are clearly personalised or made to your specification (such as bespoke-fabricated aluminium frames or custom-sized shutters) once manufacturing has commenced, in accordance with Regulation 28(1)(b) of the Consumer Contracts Regulations 2013.
              </p>
              <p className="mt-4">
                9.3 <strong className="text-white">Early Start of Services:</strong> If you request that we commence installation work within the 14-day cooling-off period, you acknowledge that you will be liable to pay for Services performed up to the point of cancellation.
              </p>
              <p className="mt-4">
                9.4 <strong className="text-white">Cancellation by Business Customers:</strong> Business Customers do not have a statutory right to cancel once a Contract has been formed. If you wish to cancel, you must notify us in writing. We reserve the right to retain the deposit and to charge for any Goods ordered, fabricated, or otherwise committed to on your behalf prior to cancellation.
              </p>
              <p className="mt-4">
                9.5 <strong className="text-white">Cancellation by Us:</strong> We reserve the right to cancel the Contract at any time before commencement of work if circumstances outside our control make it impracticable to proceed. In this event, we will refund any deposit paid in full within 14 days.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">12. Complaints Procedure</h2>
              <p>
              ...
              <address className="not-italic mt-4 pl-4 border-l-4 border-gold space-y-1">
                <p className="font-semibold text-white">Urban Shopfronts Limited</p>
                <p>
                  Email:{' '}
                  <a
                    href="mailto:sales@urbanshopfronts.co.uk"
                    className="text-gold hover:text-gold-light transition-colors"
                  >
                    sales@urbanshopfronts.co.uk
                  </a>
                </p>
              </address>
              <p className="mt-4">
                12.2 We will acknowledge all written complaints within <strong className="text-white">3 working days</strong> and aim to provide a full response within <strong className="text-white">14 working days</strong>.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <p>
                13.1 These Terms and any dispute or claim arising out of or in connection with them (including non-contractual disputes or claims) shall be governed by and construed in accordance with the law of <strong className="text-white">England and Wales</strong>.
              </p>
              <p className="mt-4">
            ...
            {/* 14. General */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">14. General</h2>
              <p>
                14.1 <strong className="text-white">Entire Agreement:</strong> These Terms, together with the accepted Quotation, constitute the entire agreement between the parties and supersede all previous discussions, correspondence, negotiations, and agreements relating to the subject matter.
              </p>
              <p className="mt-4">
                14.2 <strong className="text-white">Severability:</strong> If any provision of these Terms is found to be unlawful, void, or unenforceable, that provision shall be deemed severable and shall not affect the validity and enforceability of the remaining provisions.
              </p>
              <p className="mt-4">
                14.3 <strong className="text-white">Waiver:</strong> No failure or delay by us in exercising any right or remedy under these Terms shall constitute a waiver of that right or remedy.
              </p>
              <p className="mt-4">
                14.4 <strong className="text-white">Third Parties:</strong> These Terms do not confer any rights on any third party under the Contracts (Rights of Third Parties) Act 1999.
              </p>
              <p className="mt-4">
                14.5 <strong className="text-white">Amendments:</strong> We reserve the right to amend these Terms at any time. The version in force at the time a Contract is formed shall apply to that Contract.
              </p>
            </section>

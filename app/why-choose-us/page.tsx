...
export const metadata: Metadata = {
  title: 'Why Choose Urban Shopfronts | Best UK Shopfront Company',
  description:
    'Discover why Urban Shopfronts is the best shopfront company in the UK. Companies House registered, 10+ years combined experience, nationwide coverage across 16 cities, and 24/7 emergency response.',
  alternates: {
    canonical: 'https://www.urbanshopfronts.co.uk/why-choose-us',
  },
  openGraph: {
    title: 'Why Choose Urban Shopfronts | Best UK Shopfront Company',
    description:
    ...
    url: 'https://www.urbanshopfronts.co.uk/why-choose-us',
  },
};
...
const comparisons = [
  { urban: 'Written workmanship guarantees', typical: 'Verbal promises with no paperwork' },
  { urban: 'Companies House registered', typical: 'Unregistered traders' },
  { urban: 'CSCS-carded, trained installers', typical: 'Untrained or uncarded labour' },
  { urban: 'Full insurance documentation provided', typical: 'No certificates or compliance records' },
  { urban: 'Dedicated project manager on every job', typical: 'No single point of contact' },
  { urban: 'Post-installation inspection and sign-off', typical: 'Walk away once fitted' },
];

const testimonials = [
  { name: 'James Whitfield', business: 'Whitfield & Sons Butchers', location: 'Leeds', quote: 'Urban replaced our roller shutter in under a day. Genuinely one of the best trade experiences we have had.' },
  ...
  { name: 'Fiona Campbell', business: 'Campbell Opticians', location: 'Edinburgh', quote: 'Listed building constraints made this tricky. Urban navigated planning approval and delivered beautifully.' },
];
    ...
    <>
      ...
      <section className="section-padding bg-gradient-dark">
        <div className="container-max">
          ...
          <h1 className="font-heading text-white" style={{ fontSize: 'clamp(2rem, 5vw, 3.25rem)', lineHeight: 1.15, marginTop: '1.5rem' }}>
            Why Businesses Choose <span className="text-gradient-gold">Urban Shopfronts</span>
          </h1>
      ...
      <section className="section-padding bg-grey-50">
        <div className="container-max" style={{ maxWidth: '52rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0', borderRadius: '0.75rem', overflow: 'hidden' }}>
            <div className="bg-navy" style={{ padding: '0.75rem 1rem' }}><strong className="text-gold">Urban Shopfronts</strong></div>
            ...
            {comparisons.map((c, i) => (
              <div key={i} style={{ display: 'contents' }}>
                <div style={{ padding: '0.75rem 1rem', background: i % 2 === 0 ? '#f0fdf4' : '#fff', fontSize: '0.95rem' }} className="text-charcoal">&#10003; {c.urban}</div>
      ...
      <section className="section-padding bg-gradient-dark" style={{ textAlign: 'center' }}>
        <div className="container-max" style={{ maxWidth: '36rem' }}>
          ...
          <p className="text-grey-300" style={{ marginBottom: '1.5rem' }}>Get a free, no-obligation site survey and quote. Call us on <a href="tel:07471043827" className="text-gold" style={{ textDecoration: 'underline' }}>07471 043827</a> or request a callback online.</p>

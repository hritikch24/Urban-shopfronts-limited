...
const slug = 'shopfront-installation-cost-uk-2025';
const pageTitle = 'Shopfront Installation Costs in the UK (2025): What to Expect';
const pageDesc = 'A detailed breakdown of shopfront installation costs across the UK in 2025, covering aluminium shopfronts, roller shutters, security doors, and what factors affect pricing.';
...
const faqs = [
  {
    question: 'How much does an aluminium shopfront cost in the UK in 2025?',
    answer:
...
export default function ShopfrontCostUK2025Page() {
  return (
    <>
      <SchemaMarkup
        type="FAQPage"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `https://www.urbanshopfronts.co.uk/blog/${slug}`, datePublished: '2025-05-01', dateModified: '2025-05-01',
        ...
        <div className="container-max max-w-3xl">
          <Breadcrumbs
            items={[
              ...
              { label: 'Shopfront Installation Costs UK 2025' },
            ]}
          />
          ...
          <p className="text-charcoal leading-relaxed mb-4">Aluminium is the industry standard for commercial shopfronts in the UK. Here are typical 2025 price ranges for supply and installation:</p>
          ...
          <p className="text-charcoal leading-relaxed mb-6">
            ...
            <Link href="/contact" className="text-gold font-medium hover:underline">Urban Shopfronts</Link>, all site surveys are free, and our quotations break down every cost element so you can make an informed decision.
          </p>

      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `https://www.urbanshopfronts.co.uk/blog/${slug}`, datePublished: '2025-04-01', dateModified: '2026-06-13',

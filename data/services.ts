...
export const services: Service[] = [
  {
    ...
    metaDescription:
      'Toughened glass shopfronts with thermally broken aluminium frames. DDA-compliant entrances, powder-coat finishes, BS EN 12150 safety glazing. Free site survey — call 07471 043827.',
...
Every installation begins with a measured survey of the existing opening or structural aperture. We co-ordinate with the structural engineer's lintel design where a new opening is being formed, and we take the relevant Party Wall Act notifications into account for terraced or semi-detached commercial properties. Our installation teams are CSCS-carded and follow a site-specific method statement and risk assessment for every project.`,
...

  {
    ...
    metaDescription:
      'Commercial roller shutter installation across the UK. Manual, electric & fire-rated options. LPS 1175 security-rated. Free site survey — call 07471 043827.',
...
Urban Shopfronts designs, supplies, and installs roller shutters across a wide range of commercial applications, from small retail units requiring a face-fit manual curtain to large industrial loading bays needing a high-speed, motor-driven door with full automation and safety edge protection.
...
Installation of fire shutters must be completed and certified by a company with appropriate third-party accreditation. Urban Shopfronts holds the relevant certification and provides a fire shutter completion certificate that forms part of the building's fire safety record.
...
Urban Shopfronts supplies and installs commercial security doors across a broad range of applications — back-of-house access points, warehouse and depot entrances, plant rooms, server rooms, cash-handling areas, and anywhere else where the consequence of an unauthorised breach is severe.
...
Urban Shopfronts designs, installs, and maintains automatic door systems for commercial clients across the UK. We work with sliding, swing, and folding automatic configurations, using drive units from established European manufacturers who certify their products to the relevant harmonised standards.
...
Urban Shopfronts designs and installs commercial aluminium bi-fold systems to suit openings from 2 m to over 12 m in width. Our systems are sourced from fabricators whose products are independently tested and certified to the performance standards that commercial applications demand.
...
Urban Shopfronts installs fire door assemblies supplied by manufacturers holding third-party certification under the CERTIFIRE or BWF-CERTIFIRE scheme, which covers the door leaf, frame, and hardware as an integrated tested system. We also install door sets certificated under the LPCB (Loss Prevention Certification Board) scheme where this is specified by the client or their fire engineer.
...
Urban Shopfronts operates a dedicated shopfront repair service across the UK, handling everything from a single broken glass panel to extensive impact damage requiring frame replacement and structural repairs. We carry a stock of commonly needed materials — glazing, frame sections, shutter laths, locking hardware — to enable same-day or next-day response to most repair requirements.
    ...
    howItWorks: [
      {
        ...
        description:
          'Call us on 07471 043827 or submit a repair request through our website. Describe the damage and, if possible, send photographs so we can prepare before visiting.',
      },
      {
        step: 2,
...
These upgrades can often be included within the permanent repair scope, and where they improve the security specification of the premises, insurers will sometimes contribute to the cost as part of the repair claim.`,
    ...
    howItWorks: [
      {
        ...
        description:
          'Call our emergency line on 07471 043827. We are available 24 hours a day, 7 days a week. Let us know the nature of the damage and the property address.',
      },
      {
        step: 2,
    ...
    peopleAlsoAsk: [
      ...
      },
      {
        ...
        answer:
          'Call us immediately on 07471 043827 and, if there is a security risk, also contact the police. Do not attempt to clear broken glass yourself. We will attend, make the premises safe, board up the opening, and advise on the next steps for permanent repair.',
      },
    ],
    ...
    howItWorks: [
      {
        ...
        description:
          'Contact us by phone on 07471 043827 or through our website. Describe the symptoms — stuck, noisy, won\'t open, won\'t close — so we can prepare the right parts and tools.',
      },
      {
        step: 2,

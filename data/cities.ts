    ...
    testimonials: [
      {
        ...
        location: 'Peckham',
        rating: 5,
        text: "We needed the installation done over a weekend because we can't afford to close during the week. Urban had the whole front stripped and reinstalled by Sunday afternoon. The new aluminium frame looks the part and the glazing is crystal clear. Customers noticed immediately.",
      },
      {
        name: 'Priya Sharma',
        ...
        location: 'Islington',
        rating: 5,
        text: 'Getting planning sign-off in our conservation area was the bit I was dreading, but Urban sorted the design statement and we got approval without needing a meeting. The bi-fold doors have transformed the café in summer — we can open the whole front onto the pavement.',
      },
      {
        ...
        rating: 4,
        text: 'Our insurers required LPS 1175 SR3 rated shutters and a security door at the rear. Urban understood exactly what was needed without us having to explain it. Documentation was complete and our insurer accepted it straight away. Solid work.',
      },
    ],
    faqs: [
      {
...
Urban Shopfronts works across Birmingham and the wider West Midlands, installing aluminium shopfronts, roller shutters, security doors, automatic entrances, and fire doors for a client base that spans independent businesses, national retail operators, and property developers.
    ...
    testimonials: [
      {
        ...
        location: 'Handsworth',
        rating: 5,
        text: "We had a shutter that hadn't closed properly for six months and three different companies couldn't fix it. Urban's engineer came out, diagnosed a worn drive gear, and had it working the same afternoon. We've since had them back to install new sliding doors at the front.",
      },
      {
        ...
        rating: 5,
        text: "Planning in the JQ is tricky, but Urban had clearly done it before. They knew which profiles the conservation officer would accept and helped us choose a colour that got approved first time. The shopfront looks exactly right for the building and we get compliments on it constantly.",
      },
      {
        name: 'Dev Patel',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "We had a very specific idea about what we wanted — a black frame with wide panes and integrated fanlight opening sections — and Urban fabricated exactly that. The planning officer raised a couple of points and Urban resolved them without any drama. Six months on and we're very happy.",
      },
      {
        name: 'Cormac Walsh',
        ...
        location: 'Ancoats',
        rating: 5,
        text: "Listed building in a conservation area — we thought it was going to be a nightmare. Urban obviously knows the Ancoats planning requirements and they guided us through the whole process. The bi-fold doors are perfect for the summer and the building looks better than it has in years.",
      },
      {
        name: 'Linda Barclay',
        ...
        location: 'Didsbury',
        rating: 4,
        text: `The automatic door has made a real difference for patients arriving in wheelchairs. Urban's installation team was efficient and tidy, and the door has worked perfectly since day one. Annual service visit was similarly straightforward.`,
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "We run a design-led business, so the shopfront had to reflect that. Urban understood the brief and fabricated a slimline aluminium frame in a specific dark bronze powder coat that looked exactly right. The glazing is immaculate and they left the site spotless.",
      },
      {
        name: 'Phil Stanway',
        ...
        location: 'Headingley',
        rating: 5,
        text: `Our old shopfront had been there since the 1980s and was letting in a draught. The new thermally broken aluminium system has made a noticeable difference to the temperature inside and the place looks ten times better. Urban's team was professional start to finish.`,
      },
      {
        name: 'Karen Liu',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "We've been on Bold Street for twelve years and this is the first time we've properly invested in the front of the shop. Urban advised us on a frame profile that suited the building and got planning approval sorted without any fuss. The result is a shopfront we're genuinely proud of.",
      },
      {
        name: 'Abi Nwosu',
        ...
        rating: 5,
        text: 'Industrial space, industrial door. Urban installed a heavy-duty sliding steel door at the entrance and an automatic pedestrian door for client visits. Both work perfectly together and look exactly right for the building.',
      },
      {
        name: 'Ian McLaughlin',
        ...
        location: 'Crosby',
        rating: 4,
        text: 'The automatic door was the main thing we needed for our older and disabled customers. Urban installed it promptly and the annual maintenance is also done by them, which keeps things simple. No problems at all.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        location: 'Montpelier',
        rating: 5,
        text: "We needed something that looked in keeping with the street but was still secure. Urban found a profile and finish that the conservation officer was happy with, and the shopfront has been complimented by the planning officer themselves when they walked past. Couldn't ask for more.",
      },
      {
        name: 'Dan Kowalski',
        ...
        location: 'Bedminster',
        rating: 5,
        text: "Urban installed the new shopfront and a bi-fold door system at the front of the restaurant. Having the full width open on summer evenings has made a real difference to our covers. The quality of the glazing and the frame finish is excellent.",
      },
      {
        name: 'Sarah Oates',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "The taproom needed something that felt right for the building — we didn't want to put a corporate shopfront on a 1920s steel workshop. Urban came up with a steel-framed sliding door arrangement that looks like it belongs there. Brilliant job.",
      },
      {
        name: 'Naomi Ashworth',
        ...
        location: 'Broomhill',
        rating: 4,
        text: "Replaced a rotting timber shopfront with a thermally broken aluminium system. The difference in the comfort of the office in winter is noticeable. Urban's quote was competitive and the installation was on time and on budget.",
      },
      {
        name: 'Leila Hassan',
        ...
        location: 'Meadowhall',
        rating: 5,
        text: 'We had a tight handover programme within the shopping centre fit-out and Urban delivered on time. Their familiarity with the Meadowhall contractor requirements made the management side of it straightforward.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        location: 'Finnieston',
        rating: 5,
        text: "We wanted a shopfront that reflected the neighbourhood — unpretentious but well-made. Urban specified a steel-framed sliding entrance with bronze powder-coated aluminium inserts that looks spot-on for the building and the street. Very pleased.",
      },
      {
        ...
        location: 'Byres Road',
        rating: 5,
        text: "The building warrant process is something I dread, but Urban handled everything. From the structural engineer coordination to the completion certificate, it was all managed without me having to chase anyone. The shopfront itself is excellent quality.",
      },
      {
        name: 'Agnes Park',
    ...
    testimonials: [
      {
        ...
        location: 'Pontcanna',
        rating: 5,
        text: "Urban understood exactly what the street needs — something that feels settled and quality without being over-designed. The new shopfront has doubled the number of compliments we get from customers. The installation team was tidy and considerate.",
      },
      {
        ...
        location: 'Roath',
        rating: 4,
        text: "We've been on Wellfield Road for thirty years and this is the first major shopfront work we've done. Urban gave us a realistic price, delivered what they promised, and the new roller shutter is a huge improvement on the old one.",
      },
      {
        name: 'Carys Thomas',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "Getting a shopfront approved in Grainger Town is not straightforward, and we needed an installer who knew that going in. Urban prepared the design statement, had a productive conversation with the conservation officer, and delivered a shopfront that we're immensely proud of. Worth every penny.",
      },
      {
        name: 'Baz Ferreira',
        ...
        location: 'Ouseburn',
        rating: 5,
        text: "We needed a door that could handle 400 people a night and still look good in the morning. Urban installed a heavy-duty sliding security door with a smart-lock system that's been completely reliable since day one. They know their stuff.",
      },
      {
        name: 'Elaine Thorpe',
    ...
    testimonials: [
      {
        ...
        location: 'Hockley',
        rating: 5,
        text: "We wanted something bold — deep navy frame with integrated LED reveals — and Urban made it work. The lead time was as quoted, the installation was efficient, and the finished shopfront is exactly what we had in mind. Loads of people comment on it.",
      },
      {
        name: 'Sandra Booth',
        ...
        rating: 5,
        text: "As architects, we're obviously particular about this sort of thing. Urban's fabrication was precise, the installation was tidy, and the conservation officer feedback on our proposal was positive. We've since recommended them to two clients.",
      },
      {
        name: 'Raj Mehta',
    ...
    testimonials: [
      {
        ...
        location: 'Belgrave',
        rating: 5,
        text: "Security is the first thing for us. Urban specified and installed a complete security package — LPS 1175 rated shutters, security door at the rear, and laminated glass throughout — that our insurer was happy with. Professional, knowledgeable, and competitive.",
      },
      {
        name: 'Mohammed Iqbal',
        ...
        rating: 5,
        text: "We wanted the whole front to open for the summer. Urban installed a four-panel bi-fold system that gives us a completely open front when it's warm. Works brilliantly and the quality is excellent for the price.",
      },
      {
        name: 'Clare Dixon',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "The automatic door was essential for patient access, and getting it approved on a listed building took persistence. Urban knew exactly how to present the application to satisfy Historic Environment Scotland and we got consent on the first application. The installation is impeccable.",
      },
      {
        ...
        rating: 5,
        text: "We'd been trying to get a new shopfront for two years before we found Urban. They sorted the listed building consent, specified a slimline frame that the conservation officer accepted, and delivered a shopfront that looks like it always belonged to the building. Genuinely delighted.",
      },
      {
        name: 'Tom Rafferty',
        ...
        location: 'Leith Walk',
        rating: 4,
        text: 'Solid work. The new aluminium front looks much smarter than the old shop and the roller shutter is much quieter than the previous one. Building warrant was handled by Urban and came through without any problems.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "The bi-fold doors have transformed the front of the restaurant. On a warm evening we can open the whole street frontage and it completely changes the atmosphere. Urban delivered on time and on budget — which doesn't always happen in the hospitality fit-out world.",
      },
      {
        name: 'Yasmin Shah',
        ...
        location: 'Shirley',
        rating: 5,
        text: "Bridal retail is very visual, and the shopfront is the first impression. Urban installed a wide-pane glazed front with LED reveal lighting that makes our displays look incredible at night. Very professional from start to finish.",
      },
      {
        ...
        rating: 4,
        text: 'Urban understood the corrosion issue without being prompted — they specified stainless fixings and a marine-grade finish as standard. Two years later and everything still looks as good as the day it was installed.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: "We wanted something that stood out — a deep teal frame with wide display panes and an oversized door handle. Urban fabricated exactly what we sketched out and the conservation officer was fine with it. It's become a bit of a local landmark, which is exactly what we wanted.",
      },
      {
        name: 'Angie Morrow',
        ...
        location: 'The Lanes',
        rating: 5,
        text: "Installing in The Lanes is not straightforward, and several companies didn't want to take it on. Urban engaged with the conservation officer early, adjusted the design based on the feedback, and we got consent without an appeal. The shopfront is beautiful and exactly right for the building.",
      },
      {
        name: 'Paul Driscoll',
        ...
        location: 'Hove',
        rating: 4,
        text: "Good quality aluminium shopfront, installed without any fuss. The marine corrosion protection was mentioned proactively — Urban specified stainless fixings and the right primer without us asking. That kind of professionalism is what you want.",
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Urban replaced our old shopfront and fitted a new roller shutter in a single day. The team arrived on time, worked cleanly, and the finish is excellent.',
      },
      {
        name: 'Claire Dunn',
        ...
        location: 'Earlsdon',
        rating: 5,
        text: 'We needed a new automatic entrance door for DDA compliance. Urban surveyed quickly, provided a clear quote, and installed within the week.',
      },
    ],
    faqs: [
      {
...
Manningham Lane and the wider Manningham area represent one of the most vibrant and commercially active corridors in the city. The dense concentration of independent retail, food, textile, and service businesses along this stretch creates a shopfront environment with specific requirements: wide display frontages, illuminated signage integration, security-rated shutters, and durable finishes that withstand heavy daily use. Urban Shopfronts has completed numerous installations along Manningham Lane and the surrounding streets, working with business owners who value quality, competitive pricing, and reliable delivery.
    ...
    testimonials: [
      {
        ...
        location: 'Manningham',
        rating: 5,
        text: 'Urban installed a wide-pane aluminium shopfront with integrated LED lighting and a security shutter. The display looks fantastic and the shutter gives us peace of mind. Very professional service from survey to completion.',
      },
      {
        name: 'Helen Bradshaw',
        ...
        location: 'Shipley',
        rating: 5,
        text: 'We needed a new shopfront that respected the character of our Victorian building while improving thermal performance. Urban specified a thermally broken system in a heritage colour that looks exactly right. The office is noticeably warmer too.',
      },
      {
        name: 'Asif Khan',
    ...
    testimonials: [
      {
        ...
        location: 'Uplands',
        rating: 5,
        text: 'Urban installed a new thermally broken aluminium shopfront with an automatic door for accessibility. The improvement to both the appearance of the practice and the comfort inside has been significant. Professional service from start to finish.',
      },
      {
        name: 'Catrin Morgan',
        ...
        location: 'Mumbles',
        rating: 5,
        text: 'The bi-fold doors have transformed the restaurant front. On a summer evening with the Gower light coming in, the whole atmosphere changes. Urban specified marine-grade everything without being asked, which tells you they know coastal work.',
      },
      {
        name: 'Darren Howell',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'We needed a shopfront that would satisfy the conservation officer and still let us show off the stock properly. Urban handled the whole listed building consent process and the finished timber-effect aluminium frontage looks like it has always been there.',
      },
      {
        name: 'Priya Nair',
      ...
      },
      {
        ...
        rating: 4,
        text: 'Good communication throughout and the roller shutter has been solid every night since. Took a little longer than quoted because of a delivery delay but Urban kept us updated the whole way.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Given how visible our shop is, opposite King\'s College, we needed a shopfront that the conservation officer would approve first time. Urban prepared the listed building consent application and the finished timber-effect frame is exactly right for the street.',
      },
      {
        name: 'Imran Chaudhry',
      ...
      },
      {
        ...
        location: 'Chesterton',
        rating: 4,
        text: 'Straightforward job, good quality aluminium units, and a fair price. Would have given five stars but there was a short delay waiting on a glass delivery. Urban kept us informed throughout.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Replacing a shopfront on The Shambles is not straightforward, but Urban understood exactly what the conservation officer would need to see. The new timber-effect frame is a perfect match for the street and trade has never been better.',
      },
      {
        name: 'Nathan Pearce',
        ...
        location: 'Stonegate',
        rating: 5,
        text: 'A genuinely difficult listed building project handled with real care. The heritage statement Urban put together for the consent application was thorough, and the finished shopfront respects the historic frontage beautifully.',
      },
      {
        ...
        location: 'Fossgate',
        rating: 4,
        text: 'Good job overall on our converted warehouse unit, nice attention to the older brickwork around the frame. Slight delay getting the final sign-off from the council but Urban managed that process for us.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'A genuinely complex listed building consent process given our position on Milsom Street, but Urban managed every step with BANES conservation officers. The finished shopfront is exactly in keeping with the Georgian frontage and looks superb.',
      },
      {
        ...
        location: 'Southgate',
        rating: 5,
        text: 'We wanted a modern entrance that still respected the setting near the Abbey. Urban got the balance right, and the planning application went through without any issues thanks to how thoroughly it was prepared.',
      },
      {
        name: 'Fiona Marchant',
        ...
        location: 'Widcombe',
        rating: 4,
        text: 'Good quality shopfront and shutter, installed with care around our Georgian building. Took a bit longer than expected waiting for listed building consent, though that was outside Urban\'s control.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Getting a shopfront right against a granite building is not something every installer understands, but Urban clearly did. The proportions match the building perfectly and the new frontage has had nothing but compliments.',
      },
      {
        name: 'Aileen Duthie',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Our building is an old warehouse conversion and we wanted a shopfront that respected the brick and cast iron rather than fighting against it. Urban got the design spot on and dealt with the council on our behalf.',
      },
      {
        name: 'Declan Ferris',
...
Across all of Milton Keynes, we work efficiently within whichever planning context applies, from the fast-moving modern retail units of Central Milton Keynes through to the heritage considerations of Stony Stratford and Newport Pagnell.`,
    testimonials: [
      ...
      },
      {
        ...
        rating: 5,
        text: 'Our high street has a proper conservation area and Urban understood that straight away, designing a shopfront in keeping with the Georgian frontage. Really pleased with how it turned out.',
      },
      {
        name: 'Dean Prosser',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'New aluminium shopfront has completely changed how the shop looks from the street. Urban were straightforward to deal with and the price was fair for the quality we got.',
      },
      {
        name: 'Leanne Cussons',
        ...
        rating: 5,
        text: 'We needed a shopfront that looked good during the day but had proper security for a late-night bar. The shutter Urban fitted is solid and the frontage looks great lit up in the evening.',
      },
      {
        name: 'Mohammed Iqbal',
        ...
        location: 'Acklam',
        rating: 4,
        text: 'Good quality shutter and shopfront, fitted quickly. Had a small issue with the shutter motor after a few weeks but Urban sorted it without any argument.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        location: 'Westbourne',
        rating: 5,
        text: 'A conservation-sensitive shopfront that still looks contemporary inside. Urban understood the Victorian proportions of the building and the planning application went through without any issues.',
      },
      {
        name: 'Sam Etheridge',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Being so close to the seafront, we needed a shopfront that could handle the salt air, and Urban specified everything to cope with that from the start. The finish still looks brand new a year on.',
      },
      {
        name: 'Kevin Doust',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Getting a shopfront right in the Lanes takes real understanding of the conservation requirements, and Urban delivered exactly that. The finished timber-effect frame fits perfectly with the historic street.',
      },
      {
        name: 'Oliver Fenn',
      ...
      },
      {
        ...
        location: 'Mile Cross',
        rating: 4,
        text: 'Good honest job, fair price, and the shutter has worked flawlessly since it went in. Would use Urban again for our next unit.',
      },
    ],
    faqs: [
      {
    ...
    testimonials: [
      {
        ...
        location: 'Cathedral Quarter',
        rating: 5,
        text: 'Being so close to the Cathedral Close meant a lot of scrutiny on our planning application, but Urban prepared everything thoroughly and it went through without a hitch. The finished shopfront is beautifully in keeping with the building.',
      },
      {
        ...
        rating: 5,
        text: 'Modern aluminium shopfront that met both the council\'s requirements and the estate\'s design guidelines. Urban managed both processes for us, which made things much easier.',
      },
      {
        name: 'Yasmin Coaker',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'A genuinely complex listed building project given our position within The Rows, but Urban clearly had the expertise for this kind of work. The heritage statement was thorough and the finished shopfront respects the galleried walkway perfectly.',
      },
      {
        ...
        rating: 5,
        text: 'Extremely impressed with how carefully Urban matched the new frame to the black-and-white timber character of the building. The council approved the application first time thanks to how well it was prepared.',
      },
      {
        name: 'Toby Grindley',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Our building has some lovely original Victorian cast-iron detailing and Urban designed the new shopfront to complement it rather than replace it. The council approved the application without any back and forth, which says a lot about the preparation.',
      },
      {
        name: 'Nadia Vaughan',
        ...
        rating: 5,
        text: 'A converted warehouse unit with real character, and Urban worked carefully around the original brick and columns to fit a modern glazed shopfront. The result looks fantastic and suits the outlet setting perfectly.',
      },
      {
        name: 'Aaron Pegler',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Close to the Cathedral, so the conservation requirements were strict, but Urban designed a shopfront that respected the Georgian building beautifully. The council approved the application with no issues.',
      },
      {
        name: 'Adrian Buckle',
        ...
        location: 'Queensgate',
        rating: 5,
        text: 'Efficient installation that met both the centre\'s design standards and our own brand requirements. Urban coordinated everything with the letting agent and the finish is excellent.',
      },
      {
